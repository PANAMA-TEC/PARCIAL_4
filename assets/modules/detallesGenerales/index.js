export const mostrar_detalles_libros = (titulo, descripcion, imagen, autor, ano) => {
        ...
        <div class="detalle_libro_contenedor row">
            ...
            <div class="detalle_libro_detalles col" style="position: relative;">
                ...
                <div class="detalle_libro_detalles_opciones row">
                    ...
                    <svg id='agregar_favorito_${id}' class="clickeable" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
