...
<body class="col">
  ...
  <div class="row navegador_superior shadow">
    <div class="contenedor row centro_navegador">
      ...
      <div class="contenedor_izquierdo_nav row">
        ...
        <svg onclick='redirigir("http://localhost/PARCIALES/PARCIAL_4/")' xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="clickeable bi bi-book"
          viewBox="0 0 16 16">
      ...
      <svg id="open_login" class="clickeable" xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-person-circle"
        viewBox="0 0 16 16">
  ...
  <div class="contenido_pagina col contenedor">
    ...
    <?php if (!isset($_GET['opcion'])): ?>
      <form class="buscador row shadow open">
    <?php else: ?>
      <div class='titulo_banner shadow'> Lista de Favoritos </div>
      <form class="buscador row shadow close">
    <?php endif; ?>
  
        <input id='libro_buscado' type='text' name='search' value=''>
  
        <svg id='boton_buscador' xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="clickeable bi bi-search"
          viewBox="0 0 16 16">
          <path
